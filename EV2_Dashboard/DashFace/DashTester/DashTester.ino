...
void loop() {
	...
	switch(testOption) {
		case 0:
		pinMode(BRAKESW,OUTPUT);
		digitalWrite(BRAKESW,LOW);
		pinMode(RTDGATE,OUTPUT);    
		digitalWrite(RTDGATE,LOW);

		pinMode(RTDBUTTON,OUTPUT);
		digitalWrite(RTDBUTTON,LOW);
		
		digitalWrite(TEENSY_LED,LOW);
		delay(1000);
		digitalWrite(TEENSY_LED,HIGH);
		digitalWrite(BRAKESW,HIGH);
		delay(1000);
		digitalWrite(TEENSY_LED,LOW);
		delay(1000);
		digitalWrite(TEENSY_LED,HIGH);
